      ...
      <div className="mt-5 flex-col  justify-between ">
        <div className="flex  justify-between  ">
          <div>
            ...
            <button
              onClick={closewallet}
              className="flex text-sm text-gray-300 transition duration-500 hover:text-blue-400 "
            >
          ...
          <button
            ...
            className="flex text-sm text-gray-300 transition duration-500 hover:text-blue-400 w-28"
          >
  ...
  return (
    <>
      <Transition.Root show={AccountConfig} as={Fragment}>
        <Dialog as="div" className="fixed z-20 inset-0 overflow-y-auto -mt-64 md:-mt-32" onClose={SetAccountConfig}>
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              <div className="inline-block align-bottom p-0.5 bg-gradient-to-br from-W3G1  via-W3G2 to-W3G3 rounded-lg   text-left overflow-hidden shadow-xl transform transition-all sm:y-8 sm:align-middle   ">
                <div className="bg-black px-4 py-5 sm:px-6 lg:px-12 rounded-md text-white">
                  <div className="flex justify-between text-xl font-light	">
                    ...
                    <button
                      onClick={() => SetAccountConfig(false)}
                      className="fa fa-times "
                      aria-hidden="true"
                    ></button>
                  </div>
                  <div className="flex justify-between">
                    <div className="text-gray-400 mt-2">Your wallet address</div>
                  </div>
                  <div className="mt-5">
                    <button
                      onClick={() => {
                        // @ts-ignore
                        Copy(`${intactWalletAddress}`);
                      }}
                      className="bg-gray-600 p-3 text-white rounded-full w-72 md:w-96 bg-gradient-to-r from-[#DA6081] via-[#8D6BCD]  to-[#7092E7]"
                    >
      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="fixed inset-0 z-40  -mt-72" onClose={setIsOpen}>
          <div className="min-h-screen px-4 text-center ">
            ...
            >
              <div className="inline-block max-w-md p-3  overflow-hidden text-left align-middle transition-all transform bg-green-50 shadow-xl rounded-2xl">
