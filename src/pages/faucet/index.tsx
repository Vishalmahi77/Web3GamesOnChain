...
const Faucet = () => {
  ...
  function sendtoken() {
    ...
    if (selected.id == check_result) {
      ...
      if (check_result == 1) {
        axios
          .get('https://pro.ip-api.com/json/?key=NyhIAYaqlelxAUZ&fields=status,message,country,city,query')
          .then(function (response) {
            if (response.data) {
              ...
              axios
                .post('https://explorer-devnet-restful-api.web3games.org/api/add_evm_address', {
                  address: inputValue,
                  ip: query,
                  country,
                  city,
        ...
        axios
          ...
          .then(function (response) {
            if (response.data) {
              ...
              // http://localhost:3004/api/insert/user
              axios
                .post('https://explorer-devnet-restful-api.web3games.org/api/add_sub_address', {
                  address: inputValue,
                  ip: query,
                  country,
                  city,
        ...
        <div className=" rounded-xl border-2 border-[#333333]   ">
          <div className="p-10 bg-[#272727]    rounded-xl bg-opacity-50 backdrop-blur-sm ">
            ...
            <div className="text-white mt-5">
              This faucet transfers TestToken on Web3Games testnets and parent chain. Confirm details before
              submitting.This faucet transfers TestToken on Web3Games testnets and parent chain. Confirm details before
              submitting.
            </div>
                  ...
                  <>
                    <div className=" relative ">
                      <Listbox.Button className="relative bg-[#303030] text-xs md:text-sm  2xl:text-lg rounded-lg p-3 text-white   w-full  border border-neutral-700   focus:border-neutral-700  outline-none ">
                        <span className="block truncate text-left  text-lg w-full mr-5 xl:mr-2">
                          {' '}
                          {selectedToken.name}
                        </span>
            ...
            <p className="flex justify-center text-center text-base font-medium text-gray-500">
              <button
                onClick={sendtoken}
                className="mt-10 rounded-full  px-32 py-2 bg-gradient-to-r from-W3G1  via-W3G2 to-W3G3 text-white font-bold text-white text-base  "
              >
                Claim
              </button>
            </p>
              ...
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">Please recheck your network and account</p>
                    </div>
                  </div>
                </div>
